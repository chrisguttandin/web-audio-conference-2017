        ...
        'chunks': {
            ...
            options: {
                patterns: [ {
                    ...
                    replacement: (match) => match.replace(/""\+e\+"/g, '"web-audio-conference-2017/scripts/"+e+"')
                } ]
            }
        },
        'csp-production': {
        ...
        'manifest': {
            ...
            options: {
                patterns: [ {
                    ...
                    match: /"\/web-audio-conference-2017(\/scripts\/main\.[a-z0-9]+.bundle.js)":\s"[a-z0-9]+"/g,
                    replacement: (_, filename) => {
                        ...
                        return `"/web-audio-conference-2017${ filename }": "${ hash }"`;
                    }
                }, {
                    ...
                    replacement: () => {
                        ...
                        return `"/web-audio-conference-2017/index.html": "${ hash }"`;
                    }
                } ]
            }
        },
        'scripts': {
            ...
            options: {
                patterns: [ {
                    ...
                    replacement: (match, filename) => {
                        return `<script type="text/javascript" src="web-audio-conference-2017/scripts/${ filename }"></script>`;
                    }
                } ]
            }
        },
        'styles': {
            ...
            options: {
                patterns: [ {
                    ...
                    replacement: (match, filename) => {
                        return `<link href="web-audio-conference-2017/styles/${ filename }" rel="stylesheet">`;
                    }
                } ]
            }
        }
